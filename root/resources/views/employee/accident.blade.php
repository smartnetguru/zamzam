{{-- Modal --}}
<div class="modal fade" id="accident" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['action'=>'EmployeeController@employeeAccident','method'=>'post','role'=>'form','class'=>'form-horizontal']) !!}
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                {!! Form::text('date',Carbon\Carbon::now()->format('Y-m-d'),['class'=>'form-control timepicker']) !!}
                            </div>
                        </div>
                    </div>
                </div>
