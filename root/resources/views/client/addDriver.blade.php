...
<div class="modal fade" id="addDriver" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['action'=>'ClientController@addDriver','method'=>'post','role'=>'form','class'=>'form-inline']) !!}
            <div class="modal-body text-center">
                {!! Form::hidden('cid',$client->id) !!}
                <div class="form-group">
                    {!! Form::label('eid','Driver:') !!}
                    {!! Form::select('eid',$repository->availableDrivers(),null,['class'=>'form-control']) !!}
                </div>
                <div class="form-group">
