{{-- Modal --}}
<div class="modal fade" id="addStatus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::model($client,['action'=>['ClientController@addStatus',$client->id],'method'=>'patch','role'=>'form','class'=>'form-inline']) !!}
