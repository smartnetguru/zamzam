...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['action'=>'VehicleController@assignDriver','method'=>'post','role'=>'form','class'=>'form-inline']) !!}
            <div class="modal-body text-center">
                {!! Form::hidden('bid',$vehicle->id) !!}
                <div class="form-group">
                    {!! Form::label('eid','DRIVER:') !!}
                    {!! Form::select('eid',$repository->availableDriver(),null,['class'=>'form-control']) !!}
                </div>
                <div class="form-group">
