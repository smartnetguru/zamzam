{{-- Modal --}}
<div class="modal fade" id="assignClient" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['action'=>'VehicleController@assignClient','method'=>'post','role'=>'form','class'=>'form-inline']) !!}
